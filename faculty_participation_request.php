...
<body>
    <?php
                ...
                $find_form="SELECT * from forms, society WHERE forms.Society_id=society.Society_id AND `Faculty_Id`='$user' AND Form_id NOT LIKE 'I%'";
                $form_result=$mysqli->query($find_form);
                while($faculty_get_form=$form_result->fetch_array())
                {
                   echo  $faculty_get_form[4]." | ".$faculty_get_form[1]."<br>";
